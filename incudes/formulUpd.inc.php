...
<form action="update.inc.php?id=<?php echo $_GET['id']?>" class="formulaire" method="POST" enctype="multipart/form-data">
...
<div class="container">
        <div class="row">
            ...
            <div class="col-8">
         <input type="text" name="firstName" id="firstName" placeholder="your first name" value="<?php echo $_GET['fn']?>">
            </div>
        </div>
        <?php
        ...
        <div class="row">
            ...
            <div class="col-8">
                <input type="text" name="lastName" id="lastName" placeholder="your last name" value="<?php echo $_GET['ln']?>">
            </div>
        </div>
       ...
       ?>  
        ...
        <div class="row">
            ...
            <label for="image" class="imgUP">
                ...
                <input type="file" name="image" id="image" accept="image/*" value="<?php echo $_GET['path']?>">
       ...
       ?>  
        ...
        <div class="row">
            ...
            <div class="col-8">
                   <input type="tel" name="tele1" id="tele1" placeholder="your phone nombre 1" value="<?php echo $_GET['tele1']?>">
            </div>
       ...
       ?>  
        ...
        <div class="row">
            ...
            <div class="col-8">
                <input type="tel" name="tele2" id="tele2" placeholder="your phone nombre 2" value="<?php echo $_GET['tele2']?>">
    ...
    <div class="row">
        ...
        <div class="col-8">
           <input type="text" name="adress"  id="adress" placeholder="your adresse" value="<?php echo $_GET['ad']?>">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-8">
            <input type="email" name="emailPer" id="emailPer" placeholder="email personnel" value="<?php echo $_GET['emp']?>">
...
<?php
    ...
    <div class="row">
        ...
        <div class="col-8">
            ...
            <input type="email" name="emailPro" id="emailPro" placeholder="email professionnel" value="<?php echo $_GET['epr']?>">
